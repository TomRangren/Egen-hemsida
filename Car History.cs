		...
		<main class="box white"><!---->
			<h2 class="info">First Car</h2> <!---->
				<p> Cars came into global use during the 20th century, and developed economies depend on them. 
					...
					became commercially available in the 2000s and are predicted to cost less to buy than gasoline cars in the early 2020s.<!---->

				</p><!---->
		<table><!---->
			<Caption>Most Used Cars 2018</Caption><!---->
				<tr><!---->
				  <th>Brand</th><!---->
				  <th>Model</th><!---->
			...
			<a href="https://www.youtube.com/watch?v=DL_mJeb6O04"> <img src="https://www.daimler.com/bilder/konzern/tradition/geschichte/anfaenge-des-automobils/benz-patent-motorwagen-w520xh208-cutout.png" alt="Picture on first car"> </a><!---->
			<a class="Link2" href="https://en.wikipedia.org/wiki/Car">Where I got my information</a><!---->
		</main><!---->
	</body><!---->
</html><!---->
